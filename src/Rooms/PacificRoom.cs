          ...
          ("I'm here to put an end to your poaching operations.", new ChoiceBranch(1, "End? Ha! I've amassed riches beyond your wildest dreams, all while the world turns a blind eye to their dying oceans. What do you think you can change?", new DialogOption[] {
            ("It's not just about wealth. It's about preserving life, protecting our oceans, and ensuring a future for all creatures, not just for profit.", new ChoiceBranch(1, "Ah, noble ideals, but the world cares little for such sentiments. Fame, fortune—that's what truly matters. No one will miss a few fish or whales.", new DialogOption[] {
              ("Every life matters, even if you can't see beyond your greed.", new ChoiceBranch(1, "Enough talk! I'll show you what really matters!", new DialogOption[] {
                ("Shoot him", new ChoiceBranch(1, "Once the captain is shoot, his crew surrenders without a fight, recognizing the loss of their leader. Their resignation becomes evident in their demeanor as they lower their weapons and offer no resistance, acknowledging the futility of further confrontation without their captain's command.\nAmidst this unexpected surrender, your crew maintains their vigilance, ensuring a peaceful transition. The subdued atmosphere echoes the unspoken understanding among the captured crew, accepting the change in leadership.\nWith the situation under control and the capitan now dead, you guide your crew back to the ship, the tension easing as the captured crew members seem willing to cooperate. The return journey to headquarters remains cautious, a silent testament to the success of your mission and the crew's adeptness in handling a delicate situation with minimal disruption.", isItGoodEnding: true, repGain: -2)),
                ("Disarm and arrest him", new ChoiceBranch(2, "Following the confrontation and the neutralization of the captain, his crew surrenders without a fight, recognizing  cowardness of their leader. You exit the room to witness your crew looking up at you, their faces lit with relief and jubilation. The victory against the poaching threat resonates through the ship as your crew celebrates, acknowledging your pivotal role in securing it.\nWith a nod of satisfaction, you make your way back to your ship, each step affirming the success achieved. The engines hum to life, and the vessel sets its course back to headquarters, propelled by the shared triumph over the ruthless exploitation of marine life. The weight of the accomplishment drives you forward, steering the ship towards new challenges, and the ongoing mission to safeguard the world's oceans.", isItGoodEnding: true, repGain: 11))
              }))
            }))
          }))
        })
    ...
    private void BuildDecision()
    {
      ...
      ChoiceBranch attack = new ChoiceBranch(1, "Do you want to attack now? ", new DialogOption[] {
          ("Yes", new ChoiceBranch(1, "STARTING THE ATTACK!", new DialogOption[] {
            ("GO!", new ChoiceBranch(1, "The moment you signal for action, the crew mobilizes with practiced efficiency. Commands echo across the deck as the ship's engines thrum to life, propelling you forward toward the concealed threat.\nYour decision to strike now is met with swift and coordinated manoeuvres. The vessel navigates the maze of islands, inching closer to the elusive target. A sense of urgency permeates the air as the crew readies the ship's defences and arms themselves for the impending confrontation.\nAs your crew launches torpedoes to prevent the target's escape, they deftly maneuver the ship closer. Fending off any resistance, your team expertly handles adversaries, swiftly silencing those who dare oppose. Positioned strategically, you leap onto the enemy vessel, leading your boarders with determined resolve.", isItGoodEnding: true, repGain: 5))
            })),
          cancel
          });
      ...
      ChoiceBranch wait = new ChoiceBranch(2, "Do you want to wait? ", new DialogOption[] {
          ("Yes", new ChoiceBranch(1, "Waiting for the nightfall...", new DialogOption[] {
            ("Nightfall: let's start the mission!",new ChoiceBranch(1, "Under the cover of the stealthy approach, your vessel glides closer to the brink of visibility, cautiously skirting the edge of being detected. With calculated precision, the ship reaches a point where any further approach risks exposure.\nYou and a select group from your crew transition to a smaller, more discreet boat, designed for silent manoeuvring. Carefully, you navigate the small craft towards the target, edging along the ship's shadowed periphery to evade notice.\nOnce close enough, your team deftly climbs the anchor, utilizing the cover of darkness and the ship's structure to conceal your approach. Silently scaling the vessel, your crew gains entry, each step calculated to avoid any undue attention.", isItGoodEnding: true,repGain: 9))
          })),
          cancel
        });
