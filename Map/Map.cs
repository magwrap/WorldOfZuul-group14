...
namespace WorldOfZuul
{
    public class Map
    {
        ...
        public static void MoveOnMap(string direction)
        {
            ...
            {
                ConsoleColorOutput.ChangeFontColor(FontTheme.Danger);
                System.Console.Write("Out of the bounds of the map! Try another direction.");
